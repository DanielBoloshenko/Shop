                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <div class="mt-2">
                            ...
                            <a class="text-decoration-none text-dark me-4" href="<?php echo e(route('catalog')); ?>">Контакты</a>
                            <a class="text-decoration-none text-dark me-4" href="<?php echo e(route('catalog')); ?>">О нас</a>
                        </div>
                        <form action="<?php echo e(route('search')); ?>" class="me-2">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item me-2">
                                    <a class="btn btn-outline-dark" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                                </li>
                            <?php endif; ?>

                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="btn btn-dark text-white" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('cartPage')); ?>">Моя корзина</a>
